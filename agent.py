...
class Agent():
    def __init__(self, alpha=0.0003, beta=0.0003, input_dims=[8], tau=0.005, scale=2, env=None, gamma=0.99, n_actions=2, max_size=1000000, layer1_size=256, layer2_size=256, batch_size=100):
        self.gamma = gamma
        self.tau = tau
        self.scale = scale
